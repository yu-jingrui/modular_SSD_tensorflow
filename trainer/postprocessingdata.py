...
class PostProcessingData:
    ...
    def get_mAP_tf_current_batch(self, predictions, localisations, glabels, gbboxes, gdifficults):
        ...
        with tf.device('/device:CPU:0'):
            ...
            c_num_gbboxes, c_tp, c_fp, c_scores = \
                tfe.bboxes_matching_batch(rscores.keys(), rscores, rbboxes, glabels, gbboxes, gdifficults)

            aps_voc07, aps_voc12 = self._compute_AP(c_scores, c_tp, c_fp, c_num_gbboxes)
    ...
    # =========================== PRIVATE METHODS ============================ #
    def _compute_AP(self, c_scores, c_tp, c_fp, c_num_gbboxes):
        aps_voc07 = {}
        aps_voc12 = {}
